...
from JailuApp.models import DepartmentEmployee


class TableDepartmentEmployee(TableObjectBase):
    ...
    def insert_row(self):
        ...
        DepartmentEmployee(id=new_guid()
    ...
    def update_row(self):
        api_response = {"error": False, "error_msg": "Insert completed successfully"}
        # populate model and perform db operation
        obj = DepartmentEmployee.objects.get(id=self.fields["id"].current_value)
        # specify updates
    ...
    def get_show_add_return_options(self):
        ...
        return """{
                params:{
                    return_object:'department_employee',
